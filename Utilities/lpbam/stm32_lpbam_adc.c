/**
  **********************************************************************************************************************
  * @file    stm32_lpbam_adc.c
  * @author  MCD Application Team
  * @brief   This file provides the basic LPBAM layer for ADC peripheral.
  **********************************************************************************************************************
  * @attention
  *
...
/** @addtogroup LPBAM_ADC_Basic_Private_Function_Prototypes LPBAM ADC Basic Private Function Prototypes
  * @{
  */

extern LPBAM_Status_t LPBAM_ADC_FillStructInfo(LPBAM_ADC_ConfNode_t const *const pConfNode,
...
/**
  * @brief  Fill linked-list node configuration according to configured parameters in the LPBAM_ADC_ConfNode_t.
  * @param  pConfNode      : Pointer to a LPBAM_ADC_ConfNode_t structure that contains node information.
                                        ...
                                        DMA_NodeConfTypeDef  *const pDMANodeConfig)
{
  ...
  /* Fill the struct information for ADC peripheral */
  status = LPBAM_ADC_FillStructInfo(pConfNode, &desc_info);
  ...
  switch (pConfNode->NodeDesc.NodeInfo.NodeID)
  {
    ...
    {
      /* Update request fields for ADC peripheral */
      pDMANodeConfig->Init.Request       = desc_info.Request;

      /* Update transfer direction for ADC peripheral */
      pDMANodeConfig->Init.Direction     = DMA_PERIPH_TO_MEMORY;
      /* Update destination increment for ADC peripheral */
      pDMANodeConfig->Init.DestInc       = DMA_DINC_INCREMENTED;
      /* Update source and destination data width for ADC peripheral */
  ...
  /* Update transfer fields for ADC peripheral */
