...
/** @defgroup LPBAM_SPI_Basic_Private_Function_Prototypes LPBAM SPI Basic Private Function Prototypes
  * @{
  */
extern LPBAM_Status_t LPBAM_SPI_FillStructInfo(LPBAM_SPI_ConfNode_t const *const pConfNode,
