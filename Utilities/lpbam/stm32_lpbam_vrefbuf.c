/**
  **********************************************************************************************************************
  * @file    stm32_lpbam_vrefbuf.c
  * @author  MCD Application Team
  * @brief   This file provides the basic LPBAM layer for VREFBUF peripheral.
  **********************************************************************************************************************
  * @attention
  *
...
/** @defgroup LPBAM_VREFBUF_Basic_Private_Function_Prototypes LPBAM VREFBUF Basic Private Function Prototypes
  * @{
  */
extern LPBAM_Status_t LPBAM_VREFBUF_FillStructInfo(LPBAM_VREFBUF_ConfNode_t const *const pConfNode,
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/** @defgroup LPBAM_VREFBUF_Basic_Exported_Functions LPBAM VREFBUF Basic Exported Functions
  * @brief    LPBAM VREFBUF Basic Exported Functions
  * @{
  */

/**
  * @brief  Fill linked-list node configuration according to configured parameters in the LPBAM_VREFBUF_ConfNode_t.
  * @param  pConfNode      : Pointer to a LPBAM_VREFBUF_ConfNode_t structure that contains node information.
                                            ...
                                            DMA_NodeConfTypeDef      *const pDMANodeConfig)
{
  ...
  /* Fill the structure information for VREFBUF peripheral */
  status = LPBAM_VREFBUF_FillStructInfo(pConfNode, &desc_info);
  ...
  /* Update transfer fields for VREFBUF peripheral */
