...
/** @defgroup LPBAM_GPIO_Basic_Private_Function_Prototypes LPBAM GPIO Basic Private Function Prototypes
  * @{
  */
extern LPBAM_Status_t LPBAM_GPIO_FillStructInfo(LPBAM_GPIO_ConfNode_t const *const pConfNode,
