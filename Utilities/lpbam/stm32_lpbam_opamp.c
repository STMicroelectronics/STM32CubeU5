...
/** @defgroup LPBAM_OPAMP_Basic_Private_Function_Prototypes LPBAM OPAMP Basic Private Function Prototypes
  * @{
  */
extern LPBAM_Status_t LPBAM_OPAMP_FillStructInfo(LPBAM_OPAMP_ConfNode_t const *const pConfNode,
