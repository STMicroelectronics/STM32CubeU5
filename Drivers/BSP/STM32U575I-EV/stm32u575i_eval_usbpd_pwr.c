/**
  ******************************************************************************
  * @file    stm32u575i_eval_usbpd_pwr.c
...
/* Includes ------------------------------------------------------------------*/
#include "stm32u575i_eval_usbpd_pwr.h"
...
#if defined(VBUS_SENSING_ON_VBUSC)
    voltage = PWR_TCPP0203_ConvertADCDataToVoltage(adc_value, 330, 47);
#else
    voltage = PWR_TCPP0203_ConvertADCDataToVoltage(adc_value, 330, 50);
#endif   /* VBUS_SENSING_ON_VBUSC */
