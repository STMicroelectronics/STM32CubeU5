/**
  ...
  ******************************************************************************
  ...
  -----------------------
   - This driver is used to drive the IO module of the STM32U575I_EVAL board.
...
/** @defgroup STM32U575I_EVAL_IO IO
  * @{
  */

/** @defgroup STM32U575I_EVAL_IO_Exported_Variables IO Exported Variables
  * @{
  */
...
/** @defgroup STM32U575I_EVAL_IO_Private_Variables IO Private Variables
  * @{
  */
...
/** @defgroup STM32U575I_EVAL_IO_Private_Functions_Prototypes IO Private Functions Prototypes
  * @{
  */
...
/** @defgroup STM32U575I_EVAL_IO_Exported_Functions IO Exported Functions
  * @{
  */
...
/**
  ...
  * @retval Pin IT status or error code
  */
int32_t BSP_IO_GetIT(uint32_t Instance, uint32_t IoPin)
{
  ...
  {
    temp = Io_Drv->ITStatus(&Io_CompObj, IoPin);
    if (temp < 0)
    {
    ...
    {
      /* Return the corresponding pin state */
      status = (int32_t)((temp == 0) ? IO_PIN_RESET : IO_PIN_SET);
    }
  }
...
/**
  ...
  * @retval The pin status or error code
  */
int32_t BSP_IO_ReadPin(uint32_t Instance, uint32_t IoPin)
{
  ...
  {
    temp = Io_Drv->ReadPin(&Io_CompObj, IoPin);
    if (temp < 0)
    {
      status = BSP_ERROR_COMPONENT_FAILURE;
    }
...
/** @defgroup STM32U575I_EVAL_IO_Private_Functions IO Private Functions
  * @{
  */
