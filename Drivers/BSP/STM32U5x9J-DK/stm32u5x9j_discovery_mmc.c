/**
  ******************************************************************************
  * @file    stm32u5x9j_discovery_mmc.c
  * @author  MCD Application Team
  * @brief   This file includes the EMMC driver mounted on STM32U5x9J-DISCOVERY
  *          board.
  ******************************************************************************
  * @attention
  *
...
--------------------------
   - This driver is used to drive the EMMC mounted on STM32U5x9J-DISCOVERY
     board.
...
/** @defgroup STM32U5x9J_DISCOVERY_MMC MMC
  * @{
  */
...
/**
  ...
  * @retval None
  */
__weak void BSP_MMC_MspInit(const MMC_HandleTypeDef *hmmc, void *Params)
{
  ...
  /* SDMMC GPIO D0 PC8, D1 PC9, D2 PC10, D3 PC11, D4 PB8, D5 PB0, D6 PC6, D7 PC7, CK PC12, CMD PD2 */
  /* GPIOC configuration */
...
/**
  ...
  * @retval None
  */
__weak void BSP_MMC_MspDeInit(const MMC_HandleTypeDef *hmmc, void *Params)
{
  /* Prevent unused argument(s) compilation warning */
  UNUSED(hmmc);
  UNUSED(Params);
