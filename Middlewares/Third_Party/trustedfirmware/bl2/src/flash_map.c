...
static const struct flash_area flash_map[] = {
    {
        ...
        .fa_device_id = FLASH_AREA_0_DEVICE_ID,
...
#if !defined(MCUBOOT_PRIMARY_ONLY)
    {
        ...
        .fa_device_id = FLASH_AREA_2_DEVICE_ID,
...
#if (MCUBOOT_IMAGE_NUMBER == 2)
    {
        ...
        .fa_device_id = FLASH_AREA_1_DEVICE_ID,
...
#if !defined(MCUBOOT_PRIMARY_ONLY)
    {
        ...
        .fa_device_id = FLASH_AREA_3_DEVICE_ID,
...
#if !defined(MCUBOOT_PRIMARY_ONLY)
    {
        ...
        .fa_device_id = FLASH_AREA_SCRATCH_DEVICE_ID,
...
ARM_DRIVER_FLASH* driver_list[2] =
{
    &FLASH_DEV_NAME,
