...
/**
  * @brief  This function is used to initialize the used FDCANx instance.
  * @retval None.
  */
static void OPENBL_FDCAN_Init(void)
{
...
/**
  * @brief  This function is used to configure FDCANx pins and then initialize the used FDCANx instance.
  * @retval None.
  */
...
/**
  * @brief  This function is used to De-initialize the FDCANx pins and instance.
  * @retval None.
  */
void OPENBL_FDCAN_DeInit(void)
{
  /* Only de-initialize the FDCANx if it is not the current detected interface */
  if (FdcanDetected == 0U)
  {
    FDCANx_FORCE_RESET();
...
/**
  * @brief  This function is used to read one byte from FDCANx pipe.
...
/**
  * @brief  This function is used to read bytes from FDCANx pipe.
...
/**
  * @brief  This function is used to send one byte through FDCANx pipe.
