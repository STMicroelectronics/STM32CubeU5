...
#define NX_DHCP_SERVER_THREAD_PRIORITY			(NETX_IP_THREAD_PRIORITY + 1)
...
#define NX_DHCP_SERVER_THREAD_STACK_SIZE            (2 * 1024)
...
//#define NX_DHCP_FAST_PERIODIC_TIME_INTERVAL     (10 * NX_IP_PERIODIC_RATE)
/* USER CODE END 2 */
