...
The **AppTCPThread**, once started:
  ...
  + Creates a <i>TCP</i> client socket
  ...
  + At each message sent, the TCP client reads the sever response and prints it on the Hyperterminal and the green led is toggled.
...
In order to make the program work, you must do the following :
 ...
 - Edit the file <code> NetXDuo/App/app_netxduo.h</code> and update the <i>TCP_SERVER_PORT</i> to connect on.
