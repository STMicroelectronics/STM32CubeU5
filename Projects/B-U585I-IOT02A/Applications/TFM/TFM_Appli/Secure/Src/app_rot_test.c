...
const TestProtection_t aProtectTests[] =
{
    ...
    { (uint32_t) &GTZC_TZIC1->IER3, "GTZC1_TZCIC IER3", TEST_WRITE_PERIPH, NOT_APPLICABLE, DENIED},
    { (uint32_t) &GTZC_TZIC2->IER3, "GTZC2_TZCIC IER3", TEST_READ_PERIPH, NOT_APPLICABLE, DENIED},
    { NS_ROM_ALIAS(FLASH_ITS_AREA_OFFSET), "ITS Read ", TEST_READ_DMA, NOT_APPLICABLE, DENIED},
    { S_RAM_ALIAS(BOOT_TFM_SHARED_DATA_BASE - SRAM1_BASE_S), "Secure Write", TEST_WRITE_DMA, NOT_APPLICABLE, DENIED},
