...
tfm_ns_init=$userAppBinary"/tfm_ns_init"$ver".bin"
tfm_s_init=$userAppBinary"/tfm_s_init"$ver".bin"
tfm_ns_sign=$userAppBinary"/tfm_ns_sign"$ver".bin"
tfm_s_sign=$userAppBinary"/tfm_s_sign"$ver".bin"
tfm_s_enc_sign=$userAppBinary"/tfm_s_enc_sign"$ver".bin"
tfm_ns_enc_sign=$userAppBinary"/tfm_ns_enc_sign"$ver".bin"
# variable for image_number = 1
tfm_init=$userAppBinary"/tfm_init"$ver".bin"
tfm_enc_sign=$userAppBinary"/tfm_enc_sign"$ver".bin"
tfm_sign=$userAppBinary"/tfm_sign"$ver".bin"
