...
set "command_init_ns=%python%%imgtool% sign -k %key_ns% %encrypt% -e little -S %image_ns_size% -M %image_ns_sectors% -H 0x20 --pad-header %option% -v %version% -s auto --align %val% %tfm_ns% %tfm_ns_init% >> %projectdir%\output.txt 2>&1"
%command_init_ns%
...
set "command_init_s=%python%%imgtool% sign -k %key_s% %encrypt% -e little -S %image_s_size% -M %image_s_sectors% -H 0x20 --pad-header %option% -v %version% -s auto --align %val% %tfm_s% %tfm_s_init% >> %projectdir%\output.txt 2>&1"
%command_init_s%
