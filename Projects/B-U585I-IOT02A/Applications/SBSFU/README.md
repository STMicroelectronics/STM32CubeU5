...
<b>1. Build</b>
   ...
   3. Build SBSFU_Appli Non Secure project.
      ...
      This step creates the SBSFU Application Non Secure binary:
            ...
            MDK-ARM:      SBSFU_Appli\MDK-ARM\B-U585I-IOT02A_NS\Exe\Project.bin
      ...
      It also produces the clear assembled SBSFU signed image for initial installation in
      SBSFU_Appli\Binary\sbsfu_init.bin,
      the encrypted assembled SBSFU signed image for download in
      SBSFU_Appli\Binary\sbsfu_enc_sign.bin,
      and the clear assembled SBSFU signed image for download in
   ...
   4. Build SBSFU_Loader Secure project.
      ...
      This step creates the SBSFU loader Secure binary:
            ...
            MDK-ARM:      SBSFU_Loader\MDK-ARM\B-U585I-IOT02A_S\Exe\Project.bin
   ...
   5. Build SBSFU_Loader Non Secure project.
      This step creates the SBSFU loader Non Secure binary:
            ...
            MDK-ARM:      SBSFU_Loader\MDK-ARM\B-U585I-IOT02A_NS\Exe\Project.bin
...
<b>8. Use Local loader App</b>
   ...
   image.
   It is possible to download a new image.
   - Download Image (#2): Download encrypted signed SBSFU_Appli image
     (SBSFU_Appli\Binary\sbsfu_enc_sign.bin) or clear signed
     SBSFU_Appli image (SBSFU_Appli\Binary\sbsfu_sign.bin)
...
<b>9. Configuration</b>
   ...
   *  Number of images
      ...
      with 2 distinct signatures, with MCUBOOT_IMAGE_NUMBER define in
