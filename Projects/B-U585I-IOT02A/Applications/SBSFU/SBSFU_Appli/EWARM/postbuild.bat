...
set "sbsfu_s_init=%userAppBinary%\sbsfu_s_init%ver%.bin"
set "sbsfu_ns_init=%userAppBinary%\sbsfu_ns_init%ver%.bin"
set "sbsfu_s_sign=%userAppBinary%\sbsfu_s_sign%ver%.bin"
set "sbsfu_ns_sign=%userAppBinary%\sbsfu_ns_sign%ver%.bin"
set "sbsfu_s_enc_sign=%userAppBinary%\sbsfu_s_enc_sign%ver%.bin"
set "sbsfu_ns_enc_sign=%userAppBinary%\sbsfu_ns_enc_sign%ver%.bin"
:: variable for image_number = 1
set "sbsfu_init=%userAppBinary%\sbsfu_init%ver%.bin"
set "sbsfu_sign=%userAppBinary%\sbsfu_sign%ver%.bin"
set "sbsfu_enc_sign=%userAppBinary%\sbsfu_enc_sign%ver%.bin"
set "sbsfu=%userAppBinary%\sbsfu.bin"
...
set "sbsfu_s=%projectdir%\B-U585I-IOT02A_S\Exe\Project.bin"
set "sbsfu_ns=%projectdir%\B-U585I-IOT02A_NS\Exe\Project.bin"
...
IF "%signing%" == "nonsecure" (
set "command_init=%python%%imgtool% sign -k %key_ns% %encrypt% -e little -S %image_ns_size% -H 0x400 --pad-header %option% -v %version% -s auto --align %val% %sbsfu_ns% %sbsfu_ns_init% >> %projectdir%\output.txt 2>&1"
goto :docommand_init
)
set "command_init=%python%%imgtool% sign -k %key_s% %encrypt% -e little -S %image_s_size% -H 0x400 --pad-header %option% -v %version% -s auto --align %val% %sbsfu_s% %sbsfu_s_init% >> %projectdir%\output.txt 2>&1"
:docommand_init
%command_init%
...
IF "%signing%" == "nonsecure" (
set "command_clear=%python%%imgtool% sign -k %key_ns% -e little -S %image_ns_size% -H 0x400 --pad-header %option% -v %version% -s auto --align %val% %sbsfu_ns% %sbsfu_ns_sign% >> %projectdir%\output.txt 2>&1"
goto :docommand_clear
)
set "command_clear=%python%%imgtool% sign -k %key_s% -e little -S %image_s_size% -H 0x400 --pad-header %option% -v %version% -s auto --align %val% %sbsfu_s% %sbsfu_s_sign% >> %projectdir%\output.txt 2>&1"
:docommand_clear
%command_clear%
...
IF "%signing%" == "nonsecure" (
set "command_enc=%python%%imgtool% sign -k %key_ns% -E %key_enc_pub% -e little -S %image_ns_size% -H 0x400 --pad-header %option% -v %version%  -s auto --align %val% %sbsfu_ns% %sbsfu_ns_enc_sign% >> %projectdir%\output.txt 2>&1"
goto :docommand_enc
)
set "command_enc=%python%%imgtool% sign -k %key_s% -E %key_enc_pub% -e little -S %image_s_size% -H 0x400 --pad-header %option% -v %version%  -s auto --align %val% %sbsfu_s% %sbsfu_s_enc_sign% >> %projectdir%\output.txt 2>&1"
:docommand_enc
%command_enc%
