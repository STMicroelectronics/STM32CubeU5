...
static void FW_Valid_SecureImage(void);
static void FW_Install_SecureImage(void);
#endif /* !defined(MCUBOOT_OVERWRITE_ONLY) */
#endif /* (MCUBOOT_IMAGE_NUMBER == 2) */
#if !defined(MCUBOOT_OVERWRITE_ONLY)
static void FW_Valid_Image(void);
static void FW_Install_Image(void);
#endif /* defined(MCUBOOT_OVERWRITE_ONLY) */
/**
  * @}
  */
...
void FW_UPDATE_Run(void)
{
  ...
  while (exit == 0U)
  {
    ...
    if (COM_Receive(&key, 1U, RX_TIMEOUT) == HAL_OK)
    {
      ...
      case '4':
          FW_Valid_SecureImage();
          break;
      case '5':
          FW_Valid_Image();
          break;
      case '6':
          FW_Install_SecureImage();
          break;
      case '7':
          FW_Install_Image();
          break;
#endif /* !defined(MCUBOOT_OVERWRITE_ONLY) && defined(MCUBOOT_IMAGE_NUMBER == 2)  */
      ...
      case '4':
          FW_Install_Image();
          break;
#endif /* defined(MCUBOOT_OVERWRITE_ONLY) && defined(MCUBOOT_IMAGE_NUMBER == 1) */
      default:
...
static void FW_Valid_SecureImage(void)
{
    SECURE_ConfirmSecureImage();
    printf("  -- Secure Firmware Confirm Done\r\n\n");
}
...
#if !defined(MCUBOOT_OVERWRITE_ONLY)
  printf("  Validate Secure Image --------------------------------- 4\r\n\n");
  printf("  Validate NonSecure Image ------------------------------ 5\r\n\n");
  printf("  Re-install Secure Image ------------------------------- 6\r\n\n");
  printf("  Re-install NonSecure Image ---------------------------- 7\r\n\n");
#endif
#else
  printf("  Download Image ---------------------------------------- 2\r\n\n");
#if !defined(MCUBOOT_OVERWRITE_ONLY)
  printf("  Validate Image ---------------------------------------- 3\r\n\n");
  printf("  Re-install Secure Image ------------------------------- 4\r\n\n");
#endif
#endif /* (MCUBOOT_IMAGE_NUMBER == 2) */
}
/**
