...
This application provides an example of FileX stack usage on STM32U5G9J-DK2 board, running in standalone mode (without ThreadX). It demonstrates how to create a Fat File system on the internal SRAM memory using FileX API.
...
### <b>Hardware and Software environment</b>
  ...
  - This application has been tested with STMicroelectronics STM32U5G9J-DK2 boards revision MB1918-U5G9ZJQ-C01
