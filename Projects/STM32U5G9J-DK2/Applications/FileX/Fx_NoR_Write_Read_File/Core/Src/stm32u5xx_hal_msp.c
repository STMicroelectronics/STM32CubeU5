...
void HAL_XSPI_MspInit(XSPI_HandleTypeDef* hxspi)
{
  ...
  */
    ...
    */
    ...
    /* HSPI1 DMA Init */
    /* GPDMA1_REQUEST_HSPI1 Init */
    handle_GPDMA1_Channel1.Instance = GPDMA1_Channel1;
    handle_GPDMA1_Channel1.Init.Request = GPDMA1_REQUEST_HSPI1;
    ...
    __HAL_LINKDMA(hxspi, hdmatx, handle_GPDMA1_Channel1);
    ...
    handle_GPDMA1_Channel0.Init.Request = GPDMA1_REQUEST_HSPI1;
