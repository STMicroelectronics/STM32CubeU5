...
/* USER CODE BEGIN fx_app_thread_entry 0*/
  ...
  printf("FileX/LevelX NOR XSPI Application Start.\n");
...
/* Format the XSPI NOR flash as FAT */
  nor_xspi_status =  fx_media_format(&nor_xspi_flash_disk,                                                            // nor_xspi_flash_disk pointer
                                     ...
                                     (VOID *)LX_NOR_XSPI_DRIVER_ID,                                                   // Device info pointer
                                     ...
                                     (LX_STM32_XSPI_FLASH_SIZE - LX_STM32_XSPI_SECTOR_SIZE)/ FX_NOR_XSPI_SECTOR_SIZE, // Total sectors minus one
  ...
  nor_xspi_status =  fx_media_open(&nor_xspi_flash_disk, FX_NOR_XSPI_VOLUME_NAME, fx_stm32_levelx_nor_driver, (VOID *)LX_NOR_XSPI_DRIVER_ID, (VOID *) fx_nor_xspi_media_memory, sizeof(fx_nor_xspi_media_memory));
