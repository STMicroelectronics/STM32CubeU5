  ...
  */
  ...
  while (1)
  {
    ...
    case 0:
      ...
      {
        aTxBuffer[index_buffer] = index_buffer;
        aRxBuffer[index_buffer] = 0;
      }
    ...
    case 1:
      ...
      if(TxCplt != 0)
      {
        ...
        if (HAL_OSPI_Receive_IT(&hospi1, aRxBuffer) != HAL_OK)
        {
          Error_Handler();
        }
    ...
    case 2:
      ...
      if(RxCplt != 0)
      {
        ...
        for (index_buffer = 0; index_buffer < BUFFERSIZE; index_buffer++)
        {
          if (aRxBuffer[index_buffer] != aTxBuffer[index_buffer])
          {
            BSP_LED_On(LED_RED);
          }
        }
...
static void MX_OCTOSPI1_Init(void)
{
  ...
  hospi1.Init.ChipSelectBoundary = 12;
