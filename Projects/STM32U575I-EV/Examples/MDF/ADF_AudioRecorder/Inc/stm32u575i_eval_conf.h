...
#define BSP_CAMERA_IT_PRIORITY        15UL  /* Default is lowest priority level */
   
/* Touch screen interrupt priority */
#define BSP_TS_IT_PRIORITY            15UL  /* Default is lowest priority level */

/* Audio interrupt priorities */
#define BSP_AUDIO_IN_IT_PRIORITY      15UL  /* Default is lowest priority level */
#define BSP_AUDIO_OUT_IT_PRIORITY     15UL  /* Default is lowest priority level */
