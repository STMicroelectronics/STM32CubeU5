...
#define DEFAULT_PREEMPTION_THRESHOLD     FX_APP_THREAD_PRIO
...
VOID fx_thread_one_entry(ULONG thread_input)
{
  ...
  /* Open the test file.  */
  sd_status =  fx_file_open(&sdio_disk, &fx_file_one, "STM32_FILE1.TXT", FX_OPEN_FOR_WRITE);
  ...
  sd_status =  fx_file_seek(&fx_file_one, 0);
  ...
  sd_status =  fx_file_write(&fx_file_one, data, sizeof(data));
  ...
  /* Close the test file.  */
  sd_status =  fx_file_close(&fx_file_one);
  ...
  /* Open the test file.  */
  sd_status =  fx_file_open(&sdio_disk, &fx_file_one, "STM32_FILE1.TXT", FX_OPEN_FOR_READ);
  ...
  sd_status =  fx_file_read(&fx_file_one, read_buffer, sizeof(data), &bytes_read);
  ...
  sd_status = tx_event_flags_set(&finish_flag,  0x01, TX_OR);

  /* Check the event setting sd_status.  */
  if (sd_status != TX_SUCCESS)
  {
...
VOID fx_thread_two_entry(ULONG thread_input)
{
  ...
  sd_status =  fx_file_create(&sdio_disk, "STM32_FILE2.TXT");
  ...
  /* Open the test file.  */
  sd_status =  fx_file_open(&sdio_disk, &fx_file_two, "STM32_FILE2.TXT", FX_OPEN_FOR_WRITE);
  ...
  /* Seek to the beginning of the test file.  */
  sd_status =  fx_file_seek(&fx_file_two, 0);
  ...
  /* Write a string to the test file.  */
  sd_status =  fx_file_write(&fx_file_two, data, sizeof(data));
  ...
  /* Close the test file.  */
  sd_status =  fx_file_close(&fx_file_two);
  ...
  /* Open the test file.  */
  sd_status =  fx_file_open(&sdio_disk, &fx_file_two, "STM32_FILE2.TXT", FX_OPEN_FOR_READ);
  ...
  /* Read the content of the test file.  */
  sd_status =  fx_file_read(&fx_file_two, read_buffer, sizeof(data), &bytes_read);
  ...
  sd_status = tx_event_flags_set(&finish_flag,  0x10, TX_OR);
