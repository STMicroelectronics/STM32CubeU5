...
#define BSP_SD_IT_PRIORITY            10U  /* Default is lowest priority level */
#define BSP_SD_RX_IT_PRIORITY         10U  /* Default is lowest priority level */
#define BSP_SD_TX_IT_PRIORITY         10U  /* Default is lowest priority level */
