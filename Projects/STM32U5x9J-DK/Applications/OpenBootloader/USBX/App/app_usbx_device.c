...
{
  /* Set Rx FIFO */
  HAL_PCDEx_SetRxFiFo(&hpcd_USB_HS, 0x200U);
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_HS, 0U, 0x80U);
  HAL_PCDEx_SetTxFiFo(&hpcd_USB_HS, 1U, 0x174U);

  /* initialize the device controller driver*/
  _ux_dcd_stm32_initialize((ULONG)USB_OTG_HS, (ULONG)&hpcd_USB_HS);
}
