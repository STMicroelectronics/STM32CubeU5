...
This application provides an example of Azure RTOS USBX stack usage on STM32U5A5xx board,
...
### <b>Hardware and Software environment</b>
  ...
  - This example has been tested with STMicroelectronics NUCLEO-U5A5ZJ-Q boards Revision MB1549-U5A5JQ-C02 and can be easily tailored to any other supported device and development board.
