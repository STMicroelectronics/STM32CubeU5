...
This project is targeted to run on STM32U5A5xx device on NUCLEO-U5A5ZJ-Q board from STMicroelectronics.
...
### <b>Hardware and Software environment</b>
  ...
  - This template runs on STM32U5A5xx devices.

  - This template has been tested with STMicroelectronics NUCLEO-U5A5ZJ-Q
