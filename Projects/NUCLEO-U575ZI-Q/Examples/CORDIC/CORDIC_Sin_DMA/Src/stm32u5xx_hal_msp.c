...
void HAL_CORDIC_MspInit(CORDIC_HandleTypeDef* hcordic)
{
  ...
  /* USER CODE END CORDIC_MspInit 0 */
    ...
    /* CORDIC DMA Init */
    /* GPDMA1_REQUEST_CORDIC_READ Init */
    handle_GPDMA1_Channel2.Instance = GPDMA1_Channel2;
    handle_GPDMA1_Channel2.Init.Request = GPDMA1_REQUEST_CORDIC_READ;
    ...
    handle_GPDMA1_Channel1.Init.Request = GPDMA1_REQUEST_CORDIC_WRITE;
