...
/**
  * @brief  DMA Linked-list List_GPDMA1_Channel0 configuration
  * @param  None
  * @retval None
  */
HAL_StatusTypeDef MX_List_GPDMA1_Channel0_Config(void)
{
  ...
  ret |= HAL_DMAEx_List_BuildNode(&pNodeConfig, &Node_GPDMA1_Channel0);
