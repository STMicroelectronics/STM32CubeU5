...
/* Define used to enable Virtual Com Port use : 
     USE_VCP_CONNECTION == 0
       IDE output print is used to print Command Code of this example. See readme.html for more details.
     USE_VCP_CONNECTION == 1
       USART1 instance is used to print Command Code of this example. (TX on PA.9, RX on PA.10)
...
/* USART2 instance is used. (TX on PA.9, RX on PA.10)
   (please ensure that USART communication between the target MCU and ST-LINK MCU is properly enabled 
    on HW board in order to support Virtual Com Port) */
