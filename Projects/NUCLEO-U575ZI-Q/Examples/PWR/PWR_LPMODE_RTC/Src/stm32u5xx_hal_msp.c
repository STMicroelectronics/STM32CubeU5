...
#endif /* (defined (SYSTEM_STOP3_MODE) || defined (SYSTEM_STANDBY_MODE) || defined (SYSTEM_SHUTDOWN_MODE)) */

#if (defined (SYSTEM_STOP0_MODE) || defined (SYSTEM_STOP1_MODE) || defined (SYSTEM_STOP2_MODE))
