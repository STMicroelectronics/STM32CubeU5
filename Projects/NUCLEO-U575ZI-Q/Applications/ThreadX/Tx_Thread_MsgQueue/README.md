...
<i>MsgReceiverThread</i> listens on both message queues :
  ...
  - When a message is available on <i>MsgQueueTwo</i>, the <i>RED_LED</i> is toggled once.
...
<i>GREEN_LED</i> is turned OFF and <i>LED_RED</i> toggles every 1 second if any error occurs.
