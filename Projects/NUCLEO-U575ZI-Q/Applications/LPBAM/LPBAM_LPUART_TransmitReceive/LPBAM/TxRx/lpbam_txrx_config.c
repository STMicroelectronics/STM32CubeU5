...
/**
  **********************************************************************************************************************
  * @file   lpbam_txrx_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM TxRx application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  TxRx application initialization
  * @param  None
  * @retval None
  */
void MX_TxRx_Init(void)
{
  /* USER CODE BEGIN TxRx_Init 0 */

  /* USER CODE END TxRx_Init 0 */
  ...
  /* USER CODE BEGIN TxRx_Init 1 */

  /* USER CODE END TxRx_Init 1 */
}
