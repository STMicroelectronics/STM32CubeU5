...
/**
  **********************************************************************************************************************
  * @file   lpbam_tempsens_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM TempSens application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  TempSens application initialization
  * @param  None
  * @retval None
  */
void MX_TempSens_Init(void)
{
  /* USER CODE BEGIN TempSens_Init 0 */

  /* USER CODE END TempSens_Init 0 */
  ...
  /* USER CODE BEGIN TempSens_Init 1 */

  /* USER CODE END TempSens_Init 1 */
}
