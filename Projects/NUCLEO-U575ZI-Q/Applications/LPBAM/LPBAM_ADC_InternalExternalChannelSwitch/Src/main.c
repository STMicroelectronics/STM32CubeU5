...
/* Definition of ADC4 analog watchdog window thresholds */
#define LPBAM_ADC_AWD_THRESHOLD_HIGH (__LL_ADC_DIGITAL_SCALE(ADC4, LL_ADC_RESOLUTION_12B) / 2U) /* Value of ADC analog watchdog threshold high */
#define LPBAM_ADC_AWD_THRESHOLD_LOW  (0UL)                                                      /* Value of ADC analog watchdog threshold low  */
...
int main(void)
{
  ...
  ConvFullAdvConf.ContinuousConvMode                               = DISABLE;
  ...
  ConvFullAdvConf.AnalogWDGConfig[ANALOGWATCHDOG_1].WatchdogMode   = LPBAM_ADC_ANALOGWATCHDOG_SINGLE_REG;
  ConvFullAdvConf.AnalogWDGConfig[ANALOGWATCHDOG_1].Channel        = LPBAM_ADC_CHANNEL_4;
  ConvFullAdvConf.AnalogWDGConfig[ANALOGWATCHDOG_1].LowThreshold   = LPBAM_ADC_AWD_THRESHOLD_LOW;
  ConvFullAdvConf.AnalogWDGConfig[ANALOGWATCHDOG_1].HighThreshold  = LPBAM_ADC_AWD_THRESHOLD_HIGH;
  ConvFullAdvConf.AnalogWDGConfig[ANALOGWATCHDOG_1].ITMode         = ENABLE;
