...
/**
  **********************************************************************************************************************
  * @file   lpbam_incomp_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM InComp application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  InComp application initialization
  * @param  None
  * @retval None
  */
void MX_InComp_Init(void)
{
  /* USER CODE BEGIN InComp_Init 0 */

  /* USER CODE END InComp_Init 0 */
  ...
  /* USER CODE BEGIN InComp_Init 1 */

  /* USER CODE END InComp_Init 1 */
}
