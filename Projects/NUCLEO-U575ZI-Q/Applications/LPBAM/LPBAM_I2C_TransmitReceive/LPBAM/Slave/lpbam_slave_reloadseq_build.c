...
static LPBAM_I2C_SlaveRxDataDesc_t Slave_Receive_Data_1_Desc[1];
static LPBAM_I2C_SlaveTxDataDesc_t Slave_Transmit_Data_1_Desc[2];
...
static void MX_Slave_Q_Build(void)
{
  ...
  {
    if (ADV_LPBAM_I2C_SlaveRx_SetDataQ(I2C3, &pDMAListInfo_I2C, &pRxData_I2C, &Slave_Receive_Data_1_Desc[transfer_idx], &Slave_Q) != LPBAM_OK)
    {
      Error_Handler();
    }
  ...
  {
    if (ADV_LPBAM_I2C_SlaveTx_SetDataQ(I2C3, &pDMAListInfo_I2C, &pTxData_I2C, &Slave_Transmit_Data_1_Desc[transfer_idx], &Slave_Q) != LPBAM_OK)
    {
      Error_Handler();
    }
