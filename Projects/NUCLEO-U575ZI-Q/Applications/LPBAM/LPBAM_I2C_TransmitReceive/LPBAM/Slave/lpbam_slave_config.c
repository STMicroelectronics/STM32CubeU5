...
/**
  **********************************************************************************************************************
  * @file   lpbam_slave_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM Slave application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  Slave application initialization
  * @param  None
  * @retval None
  */
void MX_Slave_Init(void)
{
  /* USER CODE BEGIN Slave_Init 0 */

  /* USER CODE END Slave_Init 0 */
  ...
  /* USER CODE BEGIN Slave_Init 1 */

  /* USER CODE END Slave_Init 1 */
}
