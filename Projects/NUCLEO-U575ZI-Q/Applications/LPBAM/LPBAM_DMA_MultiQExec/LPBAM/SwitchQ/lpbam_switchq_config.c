...
/**
  **********************************************************************************************************************
  * @file   lpbam_switchq_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM SwitchQ application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  SwitchQ application initialization
  * @param  None
  * @retval None
  */
void MX_SwitchQ_Init(void)
{
  /* USER CODE BEGIN SwitchQ_Init 0 */

  /* USER CODE END SwitchQ_Init 0 */
  ...
  /* USER CODE BEGIN SwitchQ_Init 1 */

  /* USER CODE END SwitchQ_Init 1 */
}
