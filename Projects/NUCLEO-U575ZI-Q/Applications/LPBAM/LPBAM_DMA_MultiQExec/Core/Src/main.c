...
int main(void)
{
  ...
  /* LPBAM SwitchQ application init */
  MX_SwitchQ_Init();

  /* LPBAM SwitchQ application TwoQExec scenario init */
  MX_SwitchQ_TwoQExec_Init();

  /* LPBAM SwitchQ application TwoQExec scenario build */
  MX_SwitchQ_TwoQExec_Build();

  /* LPBAM SwitchQ application TwoQExec scenario link */
  MX_SwitchQ_TwoQExec_Link(&handle_LPDMA1_Channel0);

  /* LPBAM SwitchQ application TwoQExec scenario start */
  MX_SwitchQ_TwoQExec_Start(&handle_LPDMA1_Channel0);
  ...
  /* Wait for next push button press to stop the LPBAM SwitchQ application TwoQExec scenario */
  while (PushButtonState == PB_NOT_PRESSED);

  /* Turn LED2 off */
  BSP_LED_Off(LED2);

  /* LPBAM SwitchQ application TwoQExec scenario stop */
  MX_SwitchQ_TwoQExec_Stop(&handle_LPDMA1_Channel0);

  /* LPBAM SwitchQ application TwoQExec scenario unlink */
  MX_SwitchQ_TwoQExec_UnLink(&handle_LPDMA1_Channel0);

  /* LPBAM SwitchQ application TwoQExec scenario de-init */
  MX_SwitchQ_TwoQExec_DeInit();
