...
/* Buffers declaration */
uint16_t aData_Sequence1[32] = {0U};
uint16_t aData_Sequence2[32] = {0U};
/* USER CODE END PV */
...
int main(void)
{
  ...
  /* LPBAM Conv application init */
  MX_Conv_Init();

  /* LPBAM Conv application AnalogWDG scenario init */
  MX_Conv_AnalogWDG_Init();

  /* LPBAM Conv application AnalogWDG scenario build */
  MX_Conv_AnalogWDG_Build();

  /* LPBAM Conv application AnalogWDG scenario link */
  MX_Conv_AnalogWDG_Link(&handle_LPDMA1_Channel0);

  /* LPBAM Conv application AnalogWDG scenario start */
  MX_Conv_AnalogWDG_Start(&handle_LPDMA1_Channel0);
  ...
  /* Wait for next push button press to stop the LPBAM Conv application AnalogWDG scenario */
  while (PushButtonState == PB_NOT_PRESSED);

  /* Turn off LED2 */
  BSP_LED_Off(LED2);

  /* LPBAM Conv application AnalogWDG scenario stop */
  MX_Conv_AnalogWDG_Stop(&handle_LPDMA1_Channel0);

  /* LPBAM Conv application AnalogWDG scenario unlink */
  MX_Conv_AnalogWDG_UnLink(&handle_LPDMA1_Channel0);

  /* LPBAM Conv application AnalogWDG scenario de-init */
  MX_Conv_AnalogWDG_DeInit();
