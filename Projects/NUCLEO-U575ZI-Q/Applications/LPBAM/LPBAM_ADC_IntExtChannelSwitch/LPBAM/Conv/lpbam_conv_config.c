...
/**
  **********************************************************************************************************************
  * @file   lpbam_conv_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM Conv application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  Conv application initialization
  * @param  None
  * @retval None
  */
void MX_Conv_Init(void)
{
  /* USER CODE BEGIN Conv_Init 0 */

  /* USER CODE END Conv_Init 0 */
  ...
  /* USER CODE BEGIN Conv_Init 1 */

  /* USER CODE END Conv_Init 1 */
}
