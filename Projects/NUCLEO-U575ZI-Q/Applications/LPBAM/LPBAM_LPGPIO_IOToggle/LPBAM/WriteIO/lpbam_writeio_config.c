...
/**
  **********************************************************************************************************************
  * @file   lpbam_writeio_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM WriteIO application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  WriteIO application initialization
  * @param  None
  * @retval None
  */
void MX_WriteIO_Init(void)
{
  /* USER CODE BEGIN WriteIO_Init 0 */

  /* USER CODE END WriteIO_Init 0 */
  ...
  /* USER CODE BEGIN WriteIO_Init 1 */

  /* USER CODE END WriteIO_Init 1 */
}
