...
/* USER CODE BEGIN PV */
DMA_HandleTypeDef *LPBAM_DAC_MultiGain_DMAHandlers[2];
...
int main(void)
{
  ...
  /* LPBAM SigAmpli application init */
  MX_SigAmpli_Init();

  /* LPBAM SigAmpli application MultiGain scenario init */
  MX_SigAmpli_MultiGain_Init();

  /* LPBAM SigAmpli application MultiGain scenario build */
  MX_SigAmpli_MultiGain_Build();

  /* Set DMA handlers */
  LPBAM_DAC_MultiGain_DMAHandlers[0U] = &handle_LPDMA1_Channel0;
  LPBAM_DAC_MultiGain_DMAHandlers[1U] = &handle_LPDMA1_Channel1;

  /* LPBAM SigAmpli application MultiGain scenario link */
  MX_SigAmpli_MultiGain_Link(LPBAM_DAC_MultiGain_DMAHandlers[0U]);

  /* LPBAM SigAmpli application MultiGain scenario start */
  MX_SigAmpli_MultiGain_Start(LPBAM_DAC_MultiGain_DMAHandlers[0U]);
  ...
  /* Wait for next push button press to stop the LPBAM SigAmpli application MultiGain scenario */
  while (PushButtonState == PB_NOT_PRESSED);

  /* Turn off LED2 */
  BSP_LED_Off(LED2);

  /* LPBAM SigAmpli application MultiGain scenario stop */
  MX_SigAmpli_MultiGain_Stop(LPBAM_DAC_MultiGain_DMAHandlers[0U]);

  /* LPBAM SigAmpli application MultiGain scenario unlink */
  MX_SigAmpli_MultiGain_UnLink(LPBAM_DAC_MultiGain_DMAHandlers[0U]);

  /* LPBAM SigAmpli application MultiGain scenario de-init */
  MX_SigAmpli_MultiGain_DeInit();
