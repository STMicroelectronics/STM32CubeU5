...
/**
  **********************************************************************************************************************
  * @file   lpbam_pwmgen_config.c
  * @author MCD Application Team
  * @brief  Provides LPBAM PWMGen application configuration services
  **********************************************************************************************************************
  * @attention
  *
...
/* Exported functions ------------------------------------------------------------------------------------------------*/
/**
  * @brief  PWMGen application initialization
  * @param  None
  * @retval None
  */
void MX_PWMGen_Init(void)
{
  /* USER CODE BEGIN PWMGen_Init 0 */

  /* USER CODE END PWMGen_Init 0 */
  ...
  /* USER CODE BEGIN PWMGen_Init 1 */

  /* USER CODE END PWMGen_Init 1 */
}
