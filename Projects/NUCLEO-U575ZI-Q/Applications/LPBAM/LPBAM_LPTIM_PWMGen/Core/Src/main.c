...
int main(void)
{
  ...
  /* LPBAM PWMGen application init */
  MX_PWMGen_Init();

  /* LPBAM PWMGen application MultiValue init */
  MX_PWMGen_MultiValue_Init();

  /* LPBAM PWMGen application MultiValue build */
  MX_PWMGen_MultiValue_Build();

  /* LPBAM PWMGen application MultiValue link */
  MX_PWMGen_MultiValue_Link(&handle_LPDMA1_Channel0);

  /* LPBAM PWMGen application MultiValue start */
  MX_PWMGen_MultiValue_Start(&handle_LPDMA1_Channel0);
  ...
  /* Wait for next push button press to stop the LPBAM PWMGen application MultiValue scenario */
  while (PushButtonState == PB_NOT_PRESSED);

  /* Turn LED2 off */
  BSP_LED_Off(LED2);

  /* LPBAM PWMGen application MultiValue scenario stop */
  MX_PWMGen_MultiValue_Stop(&handle_LPDMA1_Channel0);

  /* LPBAM PWMGen application MultiValue scenario unlink */
  MX_PWMGen_MultiValue_UnLink(&handle_LPDMA1_Channel0);

  /* LPBAM PWMGen application MultiValue scenario de-init */
  MX_PWMGen_MultiValue_DeInit();
