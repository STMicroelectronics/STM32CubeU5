...
/* Definitions of data related to this example */
  ...
  #define VAR_CONVERTED_DATA_INIT_VALUE    (__LL_ADC_DIGITAL_SCALE(ADC4, LL_ADC_RESOLUTION_12B) + 1)
...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* using helper macro.                                                    */
    uhADCxConvertedData_Voltage_mVolt = __LL_ADC_CALC_DATA_TO_VOLTAGE(ADC4, VDDA_APPLI, uhADCxConvertedData, LL_ADC_RESOLUTION_12B);
...
static void MX_ADC4_Init(void)
{
  ...
  */
  ...
  ADC_REG_InitStruct.SequencerLength = LL_ADC4_REG_SEQ_SCAN_DISABLE;
  ...
  LL_ADC_SetLPModeAutonomousDPD(ADC4, LL_ADC_LP_AUTONOMOUS_DPD_ENABLE);
  LL_ADC_SetSamplingTimeCommonChannels(ADC4, LL_ADC_SAMPLINGTIME_COMMON_1, LL_ADC4_SAMPLINGTIME_814CYCLES_5);
  LL_ADC_SetSamplingTimeCommonChannels(ADC4, LL_ADC_SAMPLINGTIME_COMMON_2, LL_ADC4_SAMPLINGTIME_1CYCLE_5);
  ...
  */
  LL_ADC_REG_SetSequencerRanks(ADC4, LL_ADC_REG_RANK_1_ADC4, LL_ADC_CHANNEL_9);
  LL_ADC_SetChannelSamplingTime(ADC4, LL_ADC_CHANNEL_9, LL_ADC_SAMPLINGTIME_COMMON_1);
...
void ADC_Activate(void)
{
  ...
  /* Note: Feature not available on this Instance */
  }
}
