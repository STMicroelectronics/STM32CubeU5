...
/**
  ...
  *          HSI as source clock through the STM32U5xx UTILS LL API.
  ******************************************************************************
  * @attention
  *
...
/* Configuration will allow to reach a SYSCLK frequency set to 160MHz:
   Syst freq = ((HSI_VALUE / PLLM) * PLLN)/ PLLR)
               ((16MHz / 2) * 40)/ 2)             = 160MHz             */
LL_UTILS_PLLInitTypeDef sUTILS_PLLInitStruct = {2, 40, 2};

/* Variable to store AHB and APB buses clock configuration */
/* Settings to have HCLK set to 80MHz, APB1 to 80 MHz and APB2 to 160 MHz */
